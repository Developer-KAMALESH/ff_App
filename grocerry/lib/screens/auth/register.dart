...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final _townTextController = TextEditingController();
    ...
    if (isValid) {
      ...
      try {
        ...
        await FirebaseFirestore.instance.collection('users').doc(_uid).set({
          ...
          'shipping-town': _townTextController.text,
          'userWish': [],
          'userCart': [],
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          ...
                          keyboardType: TextInputType.number, //.name,
                  ...
                  TextFormField(
                    ...
                    controller: _townTextController,
                    validator: (value) {
                      if (value != 'Arakonam') {
                        return "we deliver only at Arakonam";
                      } else {
                        return null;
                      }
                    },
